...
int main()
{
    ...
    std::ofstream parameterFile("output/FourierFrustreret/parameters.csv");
    std::ofstream measurementsFile("output/FourierFrustreret/measurements.csv");
    std::ofstream FFTFile("output/FourierFrustreret/kvadratFFT.csv");
    std::ofstream FFTVarFile("output/FourierFrustreret/kvadratFFTvariance.csv");
